...
Usage in a test:
    ...
    def test_something(request, base_url, auth_headers):
        req = requests.Request(
            ...
            json={"templateId": "welcome-email", "type": "EMAIL", "content": "Hello!"},
        )
...
def build_curl(
    ...
    *,
    ...
    Returns a string like:
        curl -X POST \\
          'https://api.example.com/notification/v3/template' \\
          -H 'Authorization: Bearer abc' \\
          -H 'Content-Type: application/json' \\
          --data-raw '{"templateId": "welcome-email", "type": "EMAIL", "content": "Hello!"}'
    """
...
def attach_curl(node, req: Union[requests.PreparedRequest, requests.Request, dict]) -> None:
    ...
    In multi-step tests call before each request — the hook uses the last stored value.
    """
