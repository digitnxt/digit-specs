...
# ---------------------------------------------------------------------------
# Summary state (failed requests only)
# ---------------------------------------------------------------------------
...
def pytest_addoption(parser):
    parser.addoption(
        ...
        action="store",
        required=True,
        help="Base URL of the notification service (e.g. http://localhost:8080/notification/v3)",
    )
    parser.addoption(
        "--api-token",
        action="store",
...
# ---------------------------------------------------------------------------
# Collect FAILED tests only (for terminal summary)
# ---------------------------------------------------------------------------
