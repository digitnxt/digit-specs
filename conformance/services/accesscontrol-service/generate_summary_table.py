...
MUTATION_ERRORS = [
    ("Missing required fields", "400/422", "`code`, `message`", "Layer 3"),
    ("Wrong field types",        "400/422", "`code`, `message`", "Layer 3"),
    ("Invalid enum value",       "400/422", "`code`, `message`", "Layer 3"),
]
PATH_PARAM_ERROR = ("Resource not found", "404", "`code`, `message`", "Layer 3")
...
def rows_for_operation(method, path, operation):
    ...
    # security: [] means explicitly no auth; omitted means inherits global BearerAuth
    if security is None:
