package com.digit.accesscontrol.pubsub;
...
/**
 * Consumes tenant-migration events and triggers schema creation/migration. Mirrors the platform
 * tenant-onboarding consumer (works with both Kafka and Redis via tracer/pubsub).
 *
