# services/notification-service/conftest.py
import os
import re
import tempfile
import pytest
...
def pytest_addoption(parser):
    parser.addoption("--base-url",     action="store", required=True,
                     help="Base URL of the notification service under test")
    ...
    parser.addoption("--filestore-url",  action="store", default=None,
                     help="Filestore service URL (for attachment download cross-module tests)")
...
def service_urls(request):
    ...
    return {
        ...
        "--filestore-url": _get("--filestore-url"),
    }
